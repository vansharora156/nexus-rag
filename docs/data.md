...
This document describes the primary data source types processed by NexusRAG, detailing their file formats, ingestion strategies, structural challenges, metadata schemas, and licenses.

---

## 1. Data Inventory & Location

All document sources used in this project are located in the repository under the [data/](file:///c:/Users/DELL/OneDrive/Pictures/ask-the-company/data) directory. 

*   **Confluence Pages (.md):** [data/markdown/](file:///c:/Users/DELL/OneDrive/Pictures/ask-the-company/data/markdown)
*   **PDF Documents (.pdf):** [data/pdf/](file:///c:/Users/DELL/OneDrive/Pictures/ask-the-company/data/pdf)
*   **Slack Channels (.json):** [data/slack/](file:///c:/Users/DELL/OneDrive/Pictures/ask-the-company/data/slack)
*   **Spreadsheets (.csv):** [data/excel/](file:///c:/Users/DELL/OneDrive/Pictures/ask-the-company/data/excel)

### License & Origin
*   **Origin:** All documents are synthetically generated mock enterprise documentation representing a fictional corporation called "BigCorp".
*   **License:** Under the repository MIT license. Open to modification and reuse for testing.

---

## 2. Confluence (Markdown Pages)
...
## 3. PDF Documents (Native & Scanned)
...
## 5. Spreadsheets (Excel & CSV)

### 5.1 Source Format & Structure
